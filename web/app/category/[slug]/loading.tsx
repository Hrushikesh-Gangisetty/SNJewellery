...
/**
 * Category loading state. Deliberately identical geometry to the
 * catalogue's — the two pages have the same shape, and a customer moving
 * between them should not see the skeleton change.
 *
